  ...
  return (
    <footer className="mx-auto max-w-3xl px-4 pt-6 pb-10">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        {links.map((l) => (
          <a key={l.href} href={l.href} className="hover:text-gray-800 dark:hover:text-gray-200">
            {l.label}
          </a>
        ))}
        <span className="ml-auto">
          Built with <span className="text-red-500">♥</span> by{' '}
          <a href="https://github.com/alfg" className="hover:text-gray-800 dark:hover:text-gray-200">
            alfg
          </a>
        </span>
      </div>
