...
export default function GitHubBadge() {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 rounded-md border border-white/20 bg-white/5 px-2.5 py-1.5 text-sm transition-colors hover:border-white/35 hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:outline-none"
    >
