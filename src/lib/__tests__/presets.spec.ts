...
describe('preset commands', () => {
  it.each([
    ['h264-very-fast-1080p30',
      'ffmpeg -i input.mp4 -c:v libx264 -preset veryfast -r 30 -crf 24 -vf "scale=1920:-2" -c:a copy output.mp4'],
    ['h264-very-fast-720p30',
      'ffmpeg -i input.mp4 -c:v libx264 -preset veryfast -r 30 -crf 23 -vf "scale=1280:-2" -c:a copy output.mp4'],
    ['h264-very-fast-480p30',
      'ffmpeg -i input.mp4 -c:v libx264 -preset veryfast -r 30 -crf 22 -vf "scale=720:-2" -c:a copy output.mp4'],
    ['h264-fast-1080p30',
      'ffmpeg -i input.mp4 -c:v libx264 -preset fast -r 30 -crf 22 -vf "scale=1920:-2" -c:a copy output.mp4'],
    ['h264-fast-720p30',
      'ffmpeg -i input.mp4 -c:v libx264 -preset fast -r 30 -crf 21 -vf "scale=1280:-2" -c:a copy output.mp4'],
    ['h264-fast-480p30',
      'ffmpeg -i input.mp4 -c:v libx264 -preset fast -r 30 -crf 20 -vf "scale=720:-2" -c:a copy output.mp4'],
    ['h264-high-profile-level-4.2-6000-1080p',
      ...
      + '-vf "scale=1920:-2" -c:a copy output.mp4'],
    ['h264-main-profile-level-4.0-3000-720p',
      ...
      + '-vf "scale=1280:-2" -c:a copy output.mp4'],
    ['h264-main-profile-level-3.1-1000-480p',
      ...
      + '-vf "scale=768:-2" -c:a copy output.mp4'],
    ['h264-baseline-profile-level-3.0-600-360p',
      ...
      + '-vf "scale=480:-2" -c:a copy output.mp4'],
    ['vp9-3000-1080p',
      'ffmpeg -i input.mp4 -c:v libvpx-vp9 -b:v 3000k -g 72 -profile:v 0 -vf "scale=1920:-2" -c:a libopus output.mp4'],
    ['vp9-1500-720p',
      'ffmpeg -i input.mp4 -c:v libvpx-vp9 -b:v 1500k -g 72 -profile:v 0 -vf "scale=1280:-2" -c:a libopus output.mp4'],
  ])('%s', (slug, expected) => {
...
const recipes: [string, string][] = [
    ['web-mp4-1080p',
      ...
      + '-crf 23 -movflags faststart -vf "scale=1920:-2" -c:a aac -ar 48000 -b:a 128k output.mp4'],
    ['web-mp4-720p',
      'ffmpeg -i input.mp4 -c:v libx264 -preset medium -pix_fmt yuv420p -profile:v main -level 3.1 '
      + '-crf 23 -movflags faststart -vf "scale=1280:-2" -c:a aac -ar 48000 -b:a 128k output.mp4'],
    ['hevc-mp4-1080p',
      'ffmpeg -i input.mp4 -c:v libx265 -preset medium -pix_fmt yuv420p -crf 26 -movflags faststart '
      + '-vf "scale=1920:-2" -c:a aac -ar 48000 -b:a 128k output.mp4'],
    ...
    ['vp9-webm-1080p-cq',
      'ffmpeg -i input.mp4 -c:v libvpx-vp9 -b:v 0 -g 240 -crf 31 -vf "scale=1920:-2" '
    ...
    ['h264-visually-lossless-1080p',
      ...
      + '-vf "scale=1920:-2" -c:a aac -ar 48000 -b:a 320k output.mp4'],
    ...
    ['hevc-4k-uhd',
      ...
      + '-vf "scale=3840:-2" -c:a copy output.mp4'],
    ...
    ['denoise-old-footage-720p',
      ...
      + '-vf "scale=1280:-2,deband,vaguedenoiser=threshold=3:method=soft:nsteps=5" -c:a aac -b:a 160k output.mp4'],
    ['stabilize-action-cam-1080p',
      'ffmpeg -i input.mp4 -c:v libx264 -preset medium -pix_fmt yuv420p -crf 22 -movflags faststart '
      + '-vf "scale=1920:-2,deshake,deflicker" -c:a aac -b:a 128k output.mp4'],
    ...
    ['preview-clip-10s',
      ...
      + '-crf 23 -movflags faststart -vf "scale=1280:-2" -c:a aac -b:a 128k output.mp4'],
    ['timelapse-5x',
